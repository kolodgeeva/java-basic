...
Welcome to the **Java Basics** project! This repository contains all the code and exercises used in the _Java Basics for Beginners_ course taught by **Mariana Kolodzheieva**.
...
3. Run any `.java` file with a `main` method to test and explore!
